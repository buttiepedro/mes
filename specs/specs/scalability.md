...
| B-11 | Costo/límite de aprovisionar miles de DBs | DB-per-tenant multiplica bases | Automatización de provisioning, densificación de tenants pequeños, tiering de infra ([control-plane.md](./control-plane.md)) |
