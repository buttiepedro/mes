...
8. ✅ **Resuelto (2026-07-26) — PRD-04:** dos verticales piloto, **una por perfil** desde el día uno — **Construcción/obra** (perfil proyecto) y **Alimenticia** (perfil repetitivo) — sobre un núcleo genérico configurable; el resto del perfil proyecto (metalmecánica a medida, ingeniería bajo pedido) se suma tras validar el piloto de obra.
...
12. ✅ **Resuelto (2026-07-26) — PRD-01:** se mantiene **"Nexo" como working name** hasta el go-to-market (verificación de marca/dominio diferida y no bloqueante). **Sigue pendiente** revisar el **tagline** y el material comercial por el cambio de posicionamiento (sistema autónomo, ERP opcional).
