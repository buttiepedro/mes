...
5. ✅ **Resuelto (2026-07-11):** el operario en kiosco se autentica con PIN / badge / NFC sobre un dispositivo confiable (no un segundo factor de teléfono), con step-up para acciones críticas; el ajuste fino de UX se coordina con [ui-ux.md](./ui-ux.md) — ver [tablero de decisiones](../open-questions-board.md).
