...
| **M2** | **Capa 4 mínima — motor de eventos** | Proyección que consume eventos de Ejecución/Tarea y calcula **progreso por ejecución** | Tras avanzar tareas de una ejecución, una query devuelve su **% de progreso** derivado de los eventos | ⬜ **← siguiente** |
